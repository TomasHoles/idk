...
print("Students Count: ",type(students_count), id(students_count),hex(id(students_count)))
print("Rating: ",type(rating),id(rating),hex(id(rating)))
print("Is published: ",type(is_published),id(is_published),hex(id(is_published)))
...
print("Binarni soucet cisla {} a {} je {}".format(0x1a,myself_binary,0x1a * myself_binary))
